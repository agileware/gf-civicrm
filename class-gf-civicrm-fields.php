...
class FieldsAddOn extends \GFAddOn {
  ...
  public function plugin_settings_fields() {
    ...
    // These fields will only appear if the CMRF plugin is not active, or if "none" or a local connectional profile is selected in civicrm_rest_connection.
    // See gf-civicrm-wpcmrf.js
    $fields[] = [
      'title'       => esc_html__( 'CiviCRM API Settings', 'gf-civicrm' ),
      'id'          => 'gfcv-api-settings', // Outputs as gform-settings-section-gfcv-api-settings
      'fields'      => [ 
        [
          'type'          => 'text',
